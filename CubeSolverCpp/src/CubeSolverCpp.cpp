//============================================================================
// Name        : CubeSolverCpp.cpp
// Author      : Rasmus Göransson
// Version     :
// Copyright   : Based on java code from kociemba.org
// Description : Rubiks cube solver using the twophase algorithm developed by
//               Kociemba. Based on java code from kociemba.org but modified
//               to work with axial metric and converted to c++.
//============================================================================
