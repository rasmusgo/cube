...
public:
	...
	static std::string solutionToString(int length);

	// ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
	// generate the solution string from the array data including a separator between phase1 and phase2 moves
	static std::string solutionToString(int length, int depthPhase1);
	 ...
	 */
	static std::string solution(std::string facelets, int maxDepth, long timeOut, bool useSeparator);
