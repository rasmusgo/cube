...
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
//A simple GUI example to demonstrate how to use the package se.morotspaj.twophase
...
public class MainProgram extends javax.swing.JFrame {
	...
	private void initGUI() {
		...
		{
			SpinnerModel model = new SpinnerNumberModel(24, 1, 24, 1);
			...
			spinnerMaxMoves.addChangeListener(new ChangeListener() {
				public void stateChanged(ChangeEvent evt) {
					maxDepth = (Integer) spinnerMaxMoves.getValue();
				}
			});
		}
		...
		}
		{
			...
			spinnerTimeout.addChangeListener(new ChangeListener() {
				public void stateChanged(ChangeEvent evt) {
					maxTime = (Integer) spinnerTimeout.getValue();
				}
			});
		}
		...
		// ++++++++++++++++++++++++++++++++++ Set up Random Button ++++++++++++++++++++++++++++++++++++++++++++++++++++++++
		{
			...
			buttonRandom.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent evt) {
					// +++++++++++++++++++++++++++++ Call Random function from package se.morotspaj.twophase ++++++++++++++++++++
	...
	private void solveCube(ActionEvent evt) {
		...
		// ++++++++++++++++++++++++ Call Search.solution method from package se.morotspaj.twophase ++++++++++++++++++++++++
